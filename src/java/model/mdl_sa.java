...
public class mdl_sa {
	...
	Date date = new Date();
        ...
        String photo = "http://192.168.43.86/portal/root/client/add_photo.png";
        String tag = "waiting";
        String sql = "INSERT INTO tbl_user values('" + nik + "','" + dept + "','" + email + "','" + photo + "','" + name + "','" + phone + "','" + plant + "','" + pwd + "','" + regDate + "','" + tag + "')";
        db.simpanData(sql);
    }
    ...
    public List tampil() {
        ...
        try {
            String sql = "select * from tbl_user order by nik asc";
            rs = db.ambilData(sql);
            while (rs.next()) {
