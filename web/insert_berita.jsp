            ...
            <div class="template-page-wrapper">
                ...
                <div class="templatemo-content-wrapper">
                    <div class="templatemo-content">
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <form role="form" id="templatemo-preferences-form" action="berita?data=berita&proses=input-berita" method="post">
                                    <div class="row">
                                        <div class="col-md-3 margin-bottom-15">
                                            <label for="notes">Isi Berita</label>
                                            <input class="form-control" rows="3" id="notes" type="text" name="content" required>
                                        </div>
                                    </div>
                                    <div class="row">
                                        <div class="col-md-12 margin-bottom-30">
                                            <label for="exampleInputFile">File input</label>
                                            <input type="file" name="img_content"id="exampleInputFile" required>
