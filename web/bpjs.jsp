                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <div class="btn-group pull-right" id="templatemo_sort_btn">
                                <form class="navbar-form" action="bpjs.jsp">
                                    <input type="search" class="light-table-filter" data-table="order-table" placeholder="Filter">
                                </form>
                            </div>
                            <div class="table-responsive">
                                <h3 class="margin-bottom-15">Tabel Pengajuan BPJS Karyawan</h3>
                                <table id="myTable" class="order-table table table-striped table-hover table-bordered">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td><%=data.get(x).getNokk()%></td>
                                            <td><%=data.get(x).getNoktp()%></td>
                                            ...
                                            <td>
                                    <center>
                                         <span class="btn btn-info"><a href="cobpjs?proses=view-bpjs&id=<%=data.get(x).getId()%>">Lihat</a></span>
                                        <span class="btn btn-success"><a onclick="return konfirmasi()" href="cobpjs?proses=hapus-bpjs&id=<%=data.get(x).getId()%>">Hapus</a></span>
