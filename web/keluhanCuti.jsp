                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <div class="btn-group pull-right" id="templatemo_sort_btn">
                                    <form class="navbar-form" action="keluhanCuti.jsp">
                                        <input type="search" class="light-table-filter" data-table="order-table" placeholder="Filter">
                                    </form>
                                </div>
                                <div class="table-responsive">
                                    <h3 class="margin-bottom-15">Tabel Keluhan Cuti Karyawan</h3>
                                    <table id="myTable" class="order-table table table-striped table-hover table-bordered">
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                        <center>
                                            <span class="btn btn-info"><a href="kelcuti?proses=view-cuti&id=<%=data.get(x).getId()%>">Lihat</a></span>
                                            <span class="btn btn-success"><a onclick="return konfirmasi()"  href="kelcuti?proses=hapus-cuti&id=<%=data.get(x).getId()%>">Hapus</a></span>
