                        ...
                        <div class="col-md-12">
                            ...
                            <div class="table-responsive">
                                ...
                                <table class="table table-striped table-hover table-bordered">
                                    <h1>Update Komentar Berita Karyawan </h1>
                                    <div class="row">
                                        <div class="col-md-12">
                                            <form role="form" id="templatemo-preferences-form" action="komentar?data=komentar&proses=edit-komentar" method="post">
                                                <%
                                                ...
                                                <div class="row">
                                                    <div class="col-md-5 margin-bottom-15">
                                                        ...
                                                        <textarea class="form-control" rows="3" id="notes" type="text" name="cmtcontent" value=""><%=data.get(0).getCmtcontent()%> </textarea>
                                                    </div>
                                                </div>
                                                <div class="row">
                                                    <div class="col-md-3 margin-bottom-15">
                                                        <label for="notes">Nik</label>
                                                        <input class="form-control" rows="3"  type="text" name="nik" value="<%=data.get(0).getNik()%>">
                                                    </div>
                                                </div>  
                                                <div class="row">
                                                    <div class="col-md-3 margin-bottom-15">
                                                        <label for="notes">Id Room</label>
                                                        <input class="form-control" rows="3"  type="text" name="room_id" value="<%=data.get(0).getRoom_id()%>">
                                                    </div>
                                                </div>  
                                        </div>
                                        <div class="row">
