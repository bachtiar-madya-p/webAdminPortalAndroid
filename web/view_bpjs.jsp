                        ...
                        <div class="row">
                            <div class="col-md-12">
                                ...
                                <div class="table-responsive">
                                    ...
                                    <form role="form" id="templatemo-preferences-form" action="cobpjs?data=bpjs&proses=edit-bpjs" method="post">
                                        <div class="row">
                                            <div class="col-md-10 margin-bottom-1">    
                                                <table>
                                                    <tr>
                                                        <td>
                                                            <table>
                                                                <label>Pengajuan BPJS,tanggal <%=data.get(0).getDate()%></label>
                                                                <tr>
                                                                    <td><p class="form-control-static"><label>Nomer KK</label></p></td>
                                                                    <td>&emsp; : &emsp;</td>
                                                                    <td><%=data.get(0).getNokk()%></td>
                                                                </tr>
                                                                <tr>
                                                                    <td><p class="form-control-static"><label>NOmer KTP</label></p></td>
                                                                    <td>&emsp; : &emsp;</td>
                                                                    <td><%=data.get(0).getNoktp()%></td>
                                                                </tr>                                                                    
                                                                <tr>
                                                                ...
                                                                <tr>
                                                                    <td><p class="form-control-static"><label>Lamiran</label></p></td>
                                                                    <td>&emsp; : &emsp;</td>
