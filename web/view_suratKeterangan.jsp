                        ...
                        <div class="row">
                            <div class="col-md-12">
                                ...
                                <div class="table-responsive">
                                    ...
                                    <form role="form" id="templatemo-preferences-form" action="suketerangan?data=sketerangan&proses=edit-skt" method="post">
                                        <div class="row">
                                            <div class="col-md-10 margin-bottom-1">    
                                                <table>
                                                    <tr>
                                                        <td>
                                                            <table>
                                                                <label>Pengajuan Surat Keterangan,tanggal <%=data.get(0).getDate()%></label>
                                                                <tr>
                                                                    <td><p class="form-control-static"><label>Jenis Surat</label></p></td>
                                                                    <td>&emsp; : &emsp;</td>
                                                                    <td><%=data.get(0).getJnssurat()%></td>
                                                                </tr>
                                                                <tr>
