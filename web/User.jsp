                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <div class="btn-group pull-right" id="templatemo_sort_btn">
                                    <form class="navbar-form" action="User.jsp">
                                    ...
                                    <table id="myTable" class="order-table table table-striped table-hover table-bordered"> <!--/.idnya MyTable || tambah order-table-->
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                        <center>
                                            <span class="btn btn-primary"><a href="user_Controller?proses=edit-user&nik=<%=data.get(x).getNik()%>">Update</a></span>
                                            <span class="btn btn-success"><a onclick="return konfirmasi()" href="user_Controller?proses=hapus-user&nik=<%=data.get(x).getNik()%>">Hapus</a></span>
                                        </center>
                                        </td>
                                        </tr>
                                        <%}%>
