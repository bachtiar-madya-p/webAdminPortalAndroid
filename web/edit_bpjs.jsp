                        ...
                        <div class="col-md-12">
                            ...
                            <div class="table-responsive">
                                <table class="table table-striped table-hover table-bordered">
                                    <h1>Update Pengajuan BPJS Karyawan</h1>
                                    <div class="row">
                                        <div class="col-md-12">
                                            <form role="form" id="templatemo-preferences-form" action="cobpjs?data=bpjs&proses=edit-bpjs" method="post">
                                                ...
                                                <div class="row">
                                                    <div class="col-md-10 margin-bottom-15">
                                                        <label>Pengajuan, <%=data.get(0).getDate()%></label>
                                                        <p class="form-control-static"><label>No. KK</label>&emsp;<%=data.get(0).getNokk()%></p>
                                                        <p class="form-control-static"><label>No. KTP</label>&emsp;<%=data.get(0).getNoktp()%></p>
                                                        <p class="form-control-static">Dokumen   <label >terlampir</label></p>
                                                    </div>
                                                </div>
                                                <div class="row">
