...
<%@page import="model.mdl_beasiswa"%>
                            ...
                            <div class="col-md-12">
                                <%
                                    ...
                                    if (id != null) {
                                        ...
                                        mdl_beasiswa km = new mdl_beasiswa();
                                        km.setId(idInt);
                                ...
                                <div class="table-responsive">
                                    ...
                                    <form role="form" id="templatemo-preferences-form" action="bea_anak?data=beasiswa&proses=edit-beasiswa" method="post">
                                        <div class="row">
                                            <div class="col-md-10 margin-bottom-1">    
                                                <table>
                                                    <tr>
                                                        <td>
                                                            <table>
                                                                <label>Pendaftaran beasiswa,tanggal <%=data.get(0).getDate()%></label>
                                                                <tr>
                                                                    <td><p class="form-control-static"><label>Nama Orangtua</label></p></td>
                                                                    <td>&emsp; : &emsp;</td>
                                                                    <td><%=dataUser.get(0).getName()%></td>
                                                                </tr>
                                                                <tr>
                                                                ...
                                                                <tr>
                                                                    <td><p class="form-control-static"><label>Nama Anak</label></p></td>
                                                                    <td>&emsp; : &emsp;</td>
                                                                    <td><%=data.get(0).getNm_anak()%></td>
                                                                </tr>
                                                                <tr>
                                                                    <td><p class="form-control-static"><label>Tanggal lahir</label></p></td>
                                                                    <td>&emsp; : &emsp;</td>
                                                                    <td><%=data.get(0).getTtl()%></td>
                                                                </tr>  
                                                                <tr>
                                                                    <td><p class="form-control-static"><label>Lampiran</label></p></td>
                                                                    <td>&emsp; : &emsp;</td>
                                                                    <td><img src="bootstrap/img/doc-512.png" width="25" height="25" >  <a href="<%=data.get(0).getDoc()%>"> Download</a></td>
                                                                </tr>  
                                                            </table>
                                                        </td>
