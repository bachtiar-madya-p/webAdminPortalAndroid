...
import model.mdl_suratKeterangan;
import model.mdl_user;

public class ctl_suratKeterangan extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            out.println("<html>");
            out.println("<head>");
            out.println("<title>Servlet suketerangan</title>");            
            out.println("</head>");
            out.println("<body>");
            out.println("<h1>Servlet suketerangan at " + request.getContextPath() + "</h1>");
            out.println("</body>");
            out.println("</html>");
        } finally {
            out.close();
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        if (proses.equals("input-sketerangan")) {
            response.sendRedirect("SuKeterangan.jsp");
            return;
        } 
        else if (proses.equals("view-sketerangan")) {
            response.sendRedirect("view_suratKeterangan.jsp?id=" + request.getParameter("id"));
            return;
        } 
//        else if (proses.equals("edit-sketerangan")) {
//            response.sendRedirect("edit_keterangan.jsp?id=" + request.getParameter("id"));
//            return;
//        } 
        else if (proses.equals("hapus-sketerangan")) {
            
            mdl_suratKeterangan hm = new mdl_suratKeterangan();
