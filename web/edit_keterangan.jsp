                            ...
                            <div class="col-md-12">
                                ...
                                <div class="table-responsive">
                                    <table class="table table-striped table-hover table-bordered">
                                        <h1>Update Surat Keterangan Karyawan </h1>
                                        <div class="row">
                                            <div class="col-md-12">
                                                <form role="form" id="templatemo-preferences-form" action="suketerangan?data=sketerangan&proses=edit-sketerangan" method="post">
                                                    <%
                                                    ...
                                                    <div class="row">
                                                        <div class="col-md-10 margin-bottom-15">
                                                            <label>Detail Surat Keterangan</label>
                                                            <td>
                                                                <label>Nama</label>
                                                    ...
                                                    <div class="row">
                                                        <div class="col-md-10 margin-bottom-15">
                                                            <label>Jenis Surat, <%=data.get(0).getDate()%></label>
                                                            <p class="form-control-static" id="username"><%=data.get(0).getJnssurat()%></p>
                                                        </div>
                                                    </div>
                                                    <div class="row">
