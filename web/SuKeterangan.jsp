...
<%@page import="model.mdl_suratKeterangan"%>
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <div class="btn-group pull-right" id="templatemo_sort_btn">
                                    <form class="navbar-form" action="SuKeterangan.jsp">
                                        <input type="search" class="light-table-filter" data-table="order-table" placeholder="Filter">
                                    </form>
                                </div>
                                <div class="table-responsive">
                                    <h3 class="margin-bottom-15">Tabel Surat Keterangan Karyawan</h3>
                                    <table id="myTable" class="order-table table table-striped table-hover table-bordered">
                                        ...
                                        <tbody>
                                            <%
                                                mdl_suratKeterangan km = new mdl_suratKeterangan();
                                            ...
                                            %>
                                            <tr>
                                                <td><%=data.get(x).getJnssurat()%></td>
                                                <td><%=data.get(x).getDate()%></td>
                                                <td><img src="bootstrap/img/doc-512.png" width="25" height="25" ><a href="<%=data.get(x).getDoc()%>">Simpan</a></td>
                                                <td><%=data.get(x).getStatus()%></td>
                                                <td><%=data.get(x).getNik()%></td>
                                                <td>
                                        <center>
                                            <span class="btn btn-info"><a href="suketerangan?proses=view-sketerangan&id=<%=data.get(x).getId()%>">Lihat</a></span>
                                            <span class="btn btn-success"><a onclick="return konfirmasi()" href="suketerangan?proses=hapus-sketerangan&id=<%=data.get(x).getId()%>">Hapus</a></span>
